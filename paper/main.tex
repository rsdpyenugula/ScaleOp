...
wins; 18$\times$ better than from-scratch at 30M tokens), holding
out-of-domain, at $2\times$ training context, and on a held-out
depth-dominated pair (3 seeds). Code, checkpoints, and the frozen evaluation
corpus are released.
\end{abstract}
