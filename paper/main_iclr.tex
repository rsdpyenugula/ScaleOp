...
given quality with fewer tokens. Giving plain selection the same activation
statistics the compensation reads recovers less than half of that gap (3/3
seeds), so the gain is the re-fit, not the information. At a $33\times$ larger
budget the two converge to parity ($40.3\pm0.3$ vs.\ $40.3\pm0.5$, 3 seeds),
both far ahead of from-scratch, which transfer
