...
proj., neutral LN$^{\ast}$ & 12{,}323 \\
structured selection$^{\ast}$ & 11{,}509 \\
\bottomrule
\end{tabular}
\\[3pt]
{\footnotesize $^{\ast}$Quick-eval perplexity (the two evals agree at these
magnitudes: random init scores $\approx$66k on both). Neutral norms (gain 1,
bias 0) recover $\sim$15$\times$, so LayerNorm mismatch dominates the zero-shot
collapse; the residual gap to structured selection is small at $t{=}0$ but
$3\times$ after training (the decomposition in \S\ref{sec:projection}).}
\end{minipage}
\end{table}
...
paired comparison; its worst seed beats \textsc{subclone\_rs}'s best. The
\textsc{\_act} rows are the information-matched control of
Table~\ref{tab:actsel}: V/O and MLP selection scored by activation energy
instead of weight norm.}
\label{tab:seeded}
\begin{tabular}{lrrrr}
\toprule
...
\midrule
subclone\_rs\_act   & 86.9 & 89.8 & 85.5 & $87.4 \pm 2.2$ \\
hybrid\_rs\_act     & 81.7 & 81.4 & 77.6 & $80.2 \pm 2.3$ \\
\bottomrule
\end{tabular}
\end{table}

\subsection{1B convergence: per-seed finals and extended evaluation (\S\ref{sec:race:hardening})}
\label{app:conv1b}

\begin{table}[h]
\centering
\footnotesize
\caption{Primary pair at 1B tokens. Top: final WikiText-103 perplexity per
data-draw seed (seed 0 is the original run; seeds 1--2 re-run on the identical
protocol). Bottom: extended evaluation of the 1B checkpoints, same metrics and
guess floors as Table~\ref{tab:extended}.}
\label{tab:conv1b}
\begin{tabular}{lrrrr}
\toprule
Init & seed 0 & seed 1 & seed 2 & mean $\pm$ std \\
\midrule
subclone\_rs & 40.0 & 40.1 & 40.9 & $40.3 \pm 0.5$ \\
hybrid\_rs   & 40.0 & 40.4 & 40.5 & $40.3 \pm 0.3$ \\
random       & 57.4 & --   & --   & -- \\
\bottomrule
\end{tabular}
\\[6pt]
...
\toprule
Init & seed & C4 ppl & wk@2048 & lambada & arc\_easy & hellaswag & piqa \\
\midrule
hybrid\_rs   & 0 & 44.4 & 73.1 & 0.207 & 0.396 & 0.278 & 0.585 \\
subclone\_rs & 0 & 44.4 & 68.2 & 0.209 & 0.392 & 0.276 & 0.588 \\
hybrid\_rs   & 1 & 44.3 & 79.4 & 0.204 & 0.401 & 0.277 & 0.583 \\
subclone\_rs & 1 & 44.3 & 66.5 & 0.208 & 0.400 & 0.277 & 0.587 \\
hybrid\_rs   & 2 & 44.7 & 69.9 & 0.206 & 0.392 & 0.277 & 0.583 \\
subclone\_rs & 2 & 44.5 & 67.2 & 0.205 & 0.394 & 0.276 & 0.594 \\
\midrule
hybrid\_rs   & mean & 44.5 & $74.2\pm4.8$ & 0.206 & 0.396 & 0.277 & 0.584 \\
subclone\_rs & mean & 44.4 & $67.3\pm0.9$ & 0.207 & 0.395 & 0.276 & 0.589 \\
random       & 0 & 58.5 & 306.2 & 0.128 & 0.355 & 0.268 & 0.557 \\
\midrule
real 410M    & -- & 21.0 & 14.5 & 0.516 & 0.519 & 0.337 & 0.667 \\
\bottomrule
\end{tabular}
