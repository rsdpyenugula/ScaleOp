...
what the \emph{initialization} alone contributes. Our closed-form compensation
...
complementary question of what transfers through \emph{weights} at negligible
cost, and the two are combinable.

\paragraph{Growing pretrained models.}
The mirror direction --- initializing a \emph{larger} model from a smaller one ---
...
\emph{modulo} the transformations under which the architecture is invariant. Our
...
What is new is the \emph{setting} --- conversion between sizes of a single family
